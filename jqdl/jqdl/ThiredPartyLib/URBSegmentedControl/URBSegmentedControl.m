...
- (void)initInternal{
    ...
    self.imageColor = [UIColor redColor];
...
+ (void)initialize {
	...
	[appearance setTitleColor:[UIColor grayColor] forState:UIControlStateNormal];
...
//	[appearance setTitleShadowColor:[UIColor blackColor] forState:UIControlStateSelected];
	...
	[appearance setTitleColor:titleColor forState:UIControlStateHighlighted];
	[appearance setTitleColor:selectedTitleColor forState:UIControlStateSelected|UIControlStateHighlighted];
}
...
- (UIImage *)selectedBackgroundImage {
	...
	UIColor *segmentStrokeColor = [self.imageBackgroundColor adjustBrightness:0.75];
