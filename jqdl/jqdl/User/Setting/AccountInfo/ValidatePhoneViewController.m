...
@interface ValidatePhoneViewController (){
    UIButton *getCodeBtn;
...
@implementation ValidatePhoneViewController
...
- (void)viewDidLoad {
    ...
    if (phone.length > 10) {
        _phone.text = [NSString stringWithFormat:@"%@****%@",[phone substringWithRange:NSMakeRange(0, 3)],[phone substringWithRange:NSMakeRange(7, 4)]];
    }
